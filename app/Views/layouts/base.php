  ...
  <footer>
    <div class="footer-nav">
      <ul class="footer-links">
        ...
        <li><a href="/home/galerie">🎴 Galerie</a></li>
        <?php if (isset($_SESSION['user'])): ?>
          <li><a href="/game">🎮 Jouer</a></li>
          <li><a href="/game/classement">🏆 Classement</a></li>
          <li><a href="/auth/profile">👤 Mon Profil</a></li>
    ...
    <div class="footer-content">
      <p>🦁 &copy; <?= date('Y') ?> - Memory Savane 🐘</p>
      <a href="https://github.com/flaviemichel-laplateforme/memory.git" target="_blank" rel="noopener noreferrer" class="github-link">
